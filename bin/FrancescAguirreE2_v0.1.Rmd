...
Els SNPs amb p-valors més alts, per sobre de 1e-7, són el rs3027845 i el rs3217980. Els gens dels p-valors més significatius són variats, no hi ha gens que es repeteixin. Després d'aquests 2 SNPs sigificatius, podem veure 10 més per sobre 1e-5 que mereixen atenció.


## 2.6 Manhattan plots

Els manhattan plots són uns gràfics molt útils, per visualitzar els SNPs més significatius, i detectar regions significatives d'associació. En l’eix d’ordenades tenim el negatiu del logaritme en base 10 del p-valor no corregit calculat en la secció 2.5.
...
En concret, el snp rs9939043 està en una regió on s'han trobat més de 6 snps que es podrien arribar a conciderar possibles significatius. En aquesta regió està el gen CNTNAP4, i es podria estudiar més endavant en estudis de xarxes de gens per si té alguna relació amb l'index de massa corporal.
